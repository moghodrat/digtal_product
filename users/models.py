...
class User(AbstractBaseUser,PermissionsMixin):
    """
    An abstract base class implementing a fully featured User model with admin-compliant permission.
    ...
    def email_user(self, subject, massage, from_email=None, **kwargs):
        ...
        def is_loggedin_user(self):
            """
            Retuen Trur if user has actually logged in with valid credentials
            """
